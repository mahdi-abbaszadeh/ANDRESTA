...
#define FIFO_SINK_CSR		FIFO_SINK_1_IN_CSR_BASE
#define FIFO_SOURCE_CSR		FIFO_SOURCE_1_IN_CSR_BASE
#define FIFO_SINK_BASE		FIFO_SINK_1_OUT_BASE
#define FIFO_SOURCE_BASE		FIFO_SOURCE_1_IN_BASE
